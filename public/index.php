...
$router->add('GET', '/panel/productos', 'PanelController@productos');
$router->add('POST', '/panel/productos', 'PanelController@storeProduct');
$router->add('POST', '/panel/productos/delete', 'PanelController@deleteProduct');
$router->add('GET', '/panel/usuarios', 'PanelController@usuarios');
$router->add('POST', '/panel/usuarios/role', 'PanelController@updateUserRole');

...
<script type="module">
    ...
    function productsUI(tag = 'todos', isSearch = false) {
        ...
        container.innerHTML = productosDisponibles.map(p => {
            ...
            } else if (p.nombre.toLocaleLowerCase().includes(tag.toLocaleLowerCase().trimEnd()) || tag.trimEnd() == '') {
                return component(p);
            }
        }).join('');
    }
            ...
            <div class="flex items-center gap-4 mb-4 p-2 rounded-lg dynamic-card">
                ...
                <div class="flex-grow">
                    ...
                    <div class="flex items-center gap-2 mt-1">
                        <button onclick="updateQuantity(${x.id}, -1)" class="w-6 h-6 rounded-full bg-yellow-200 flex items-center justify-center text-xs font-bold">-</button>

...
<head>
    ...
    <title><?= $title ?? 'Registro | VANGWEAR' ?></title>
    ...
    <main class="registro-shell">
        <section class="registro-card">
            ...
            <article class="registro-form-panel">
                ...
                <form class="registro-form" id="registro-form" method="POST" action="<?= BASE_URL ?>/registro">
                    <label>
                        Nombre completo
                    ...
                    <?php if (!empty($error)): ?>
                        <strong class="msg-reg"><?= htmlspecialchars($error) ?></strong>
                    <?php endif; ?>
                    <button type="submit" class="btn-register">Crear cuenta</button>
                </form>

                <p class="footer-form">¿Ya tienes cuenta? <a href="<?= BASE_URL ?>/login">Inicia sesión</a></p>
            </article>
        </section>
    </main>
</body>
